...
public class StageEventHandler {
	...
	public static List<String> allConstellations = new ArrayList<String>(
													   Arrays.asList(AEVITAS, ARMARA, DISCIDIA, EVORSIO, VICIO, BOOTES, FORNAX, HOROLOGIUM, 
															   		 LUCERNA, MINERALIS, OCTANS, PELOTRIO, ALCARA, GELU, ULTERIA, VORUX));
