...
import com.rong.tgi.blocks.BlockStarterPortal;
...
public class CommonProxy {
	...
	public static Block starterPortal = new BlockStarterPortal();

	@SubscribeEvent(priority = EventPriority.LOW)
	public static void recipesLow(Register<IRecipe> event) {  
		if(Helper.isModLoaded("enderio") && Helper.isModLoaded("gregtech")) {
			SAGMillRecipeAutogenerator.addRecipe();
		}
		if(Helper.isModLoaded("thaumcraft") && Helper.isModLoaded("gregtech")) {
	...
	public static void registerBlocks(Register<Block> event) {
		...
		r.register(starterPortal);
		//r.register(new BlockFluidLiquidStarlight());
		//GameRegistry.registerTileEntity(TileEntityLiquidStarlight.class, new ResourceLocation(TGILibrary.MODID + "liquid_starlight"));
	}
	
	@SubscribeEvent
	public static void registerItems(Register<Item> event) {
		IForgeRegistry<Item> r = event.getRegistry();
		r.register(new ItemBlock(starterPortal).setRegistryName(starterPortal.getRegistryName()));
	}
