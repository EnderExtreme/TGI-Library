...
public class EntityManaPearl extends Entity {
    ...
    public EntityManaPearl(World worldIn) {
        super(worldIn);
    ...
    public EntityManaPearl(World worldIn, double x, double y, double z) {
        super(worldIn);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
        ...
        if (!this.world.isRemote) {
            ...
            if (this.despawnTimer > 80 && !this.world.isRemote) {
                ...
                if (this.shatterOrDrop) {
                    this.world.spawnEntity(new EntityItem(this.world, this.posX, this.posY, this.posZ, new ItemStack(Item.getByNameOrId("botania:manaresource"), 1, 1)));
                } else {
